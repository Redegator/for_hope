...
Survival = pd.read_csv(r'C:\Users\redegator\PycharmProjects\hope\united.txt', delimiter = '\t')
...
with open('log.txt', 'a') as f:
    ...
    for i in range(NUMBER_OF_RUNS):
        ...
        plt.savefig('Runs_tumour/Tumour_run{}.pdf'.format(i+1))
        # plt.show()
