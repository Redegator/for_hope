...
Survival = pd.read_csv(r'C:\Users\redegator\PycharmProjects\hope\RNAs for Nodes working for Vlad.txt', delimiter = '\t', low_memory=False)
...
nx = pd.read_csv('NX working for Vlad.txt', delimiter = '\t', low_memory=False)

# # print(np.isnan(Survival))
# pos = np.where(np.isnan(Survival))
# print("Pos:", pos)
#
# # print(Survival.iloc[1062, :])
# print(Survival.iloc[1060])
...
with open('log.txt', 'a') as f:
    ...
    for i in range(NUMBER_OF_RUNS):
        ...
        plt.savefig('Nodes_run{}.pdf'.format(i+1))
        # plt.show()
